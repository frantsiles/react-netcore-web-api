...
using FiscalMX.Application;
using FiscalMX.Infrastructure;
...
builder.Services.AddFiscalMxApplication();
builder.Services.AddFiscalMxInfrastructure(builder.Configuration);
